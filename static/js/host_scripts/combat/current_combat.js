...
import {saveCombat, combat_turn} from './combat_saver.js';
...
export function initCombatMap(element) {
...
export function startCombat(element, initiative_array = []) {
    if(event) {
...
export function progressCombat(element) {
    if(event) {
        event.stopPropagation()
    }
...
export function endCombat(element) {
    if(event) {
        event.stopPropagation()
    }
...
export function loadActiveCombat(element, initiative_list, current_turn) {
